...
export function Navbar() {
    ...
    return (
        <nav className="sticky top-0 z-50">
            {/* Orange Top Bar */}
            <div className="bg-orange-500 mx-auto max-w-7xl text-white rounded-b-[10px]">
            ...
            <div className="flex items-center gap-3">
                ...
                <Button className="gap-2 bg-[linear-gradient(90deg,#FF6B35_0%,#FE4711_100%)] hover:bg-orange-600 text-white">
