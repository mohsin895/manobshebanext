...
export function ComponentSix() {
  ...
  return (
    <div className='group w-[100%] shrink-0 snap-start sm:w-full sm:shrink sm:min-w-0' data-card>
      <div>
        <img src='/images/scholarship/exam6.png' alt='scholarship result' width={427} height={382} className='w-full aspect-[427/382] object-cover' />
      </div>
      ...
      <div className='relative mt-[-38px]'>
        ...
        >
          <path
            d='M0 24.0029C0 9.67516 12.4724 -1.46079 26.7086 0.156203L405.709 43.2042C417.837 44.5818 427 54.8441 427 67.0509V157.123C427 170.377 416.255 181.123 403 181.123H24C10.7452 181.123 0 170.377 0 157.123V24.0029Z'
            fill='url(#paint0_linear_462_497_six)'
          />
          <defs>
            <linearGradient id='paint0_linear_462_497_six' x1='2.6642e-06' y1='1.12255' x2='427' y2='181.123' gradientUnits='userSpaceOnUse'>
        ...
        <div className='relative z-10 mt-[-130px] gap-3 p-[30px] md:p-5 text-left transition-all duration-300 ease-out group-hover:items-left group-hover:text-left'>
          <div className='mt-[-30px]'>
            <h3 className='font-bn text-[16px] md:text-[24px] font-medium leading-[20px] md:leading-[32px] text-[#1A6B62]'>{t('scholarship.achievements')}</h3>
            <p className='font-bn-serif text-[14px] md:text-[16px] font-normal leading-[24px] text-[#1A6B62] line-clamp-2'>{t('scholarship.achievements_desc')}</p>
          </div>
