...
const translations: Record<Language, Record<string, string>> = {
  bn: {
    ...
    'structure.rule1': 'নৈর্ব্যক্তিক (MCQ) পদ্ধতিতে মোট ৯০ টি প্রশ্ন থাকবে। প্রতিটি প্রশ্নের মান ১ সমপরিমাণ নম্বর।',
    'structure.rule2': 'বৃক্ষরোপণে ১০ মার্ক। বৃক্ষরোপণের ছবি প্রিন্ট করে পরীক্ষার খাতার সাথে সংযুক্ত করতে হবে।',
    'structure.rule4': 'ভুল উত্তরের জন্য কোনো প্রকার কাটমার্ক বা নেগেটিভ মার্ক কাটা হবে না।',
    'structure.rule3': 'নৈর্ব্যক্তিকের চারটি অপশন (ক, খ, গ, ঘ) থেকে সঠিক উত্তরের বৃত্ত ওএমআর (OMR) শিটে কালো বল পয়েন্ট কলম দিয়ে সম্পূর্ণ ভরাট করতে হবে।',
