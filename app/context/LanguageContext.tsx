...
const translations: Record<Language, Record<string, string>> = {
    bn: {
        ...
        'faq.a1': 'আমাদের ওয়েবসাইটের হিরো সেকশনে বা কুইক এক্সেসে থাকা "নিবন্ধন করুন" বাটনে ক্লিক করুন। আপনার সঠিক ব্যক্তিগত এবং প্রাতিষ্ঠানিক তথ্য দিন, কাছের একটি পরীক্ষা কেন্দ্র নির্বাচন করুন এবং ফর্মটি জমা দিন। তাৎক্ষণিকভাবে আপনি রোল নম্বরসহ রেজিষ্ট্রেশন স্লিপ পেয়ে যাবেন।',
        'faq.q2': 'পরীক্ষার আগে সার্টিফিকেট পাওয়া যায়?',
        'faq.a2': 'আমাদের ওয়েবসাইটের হিরো সেকশনে বা কুইক এক্সেসে থাকা "নিবন্ধন করুন" বাটনে ক্লিক করুন। আপনার সঠিক ব্যক্তিগত এবং প্রাতিষ্ঠানিক তথ্য দিন, কাছের একটি পরীক্ষা কেন্দ্র নির্বাচন করুন এবং ফর্মটি জমা দিন। তাৎক্ষণিকভাবে আপনি রোল নম্বরসহ রেজিষ্ট্রেশন স্লিপ পেয়ে যাবেন।',
        'faq.q3': 'কোন মানি-ব্যাক গ্যারান্টি আছে?',
        'faq.a3': 'আমাদের ওয়েবসাইটের হিরো সেকশনে বা কুইক এক্সেসে থাকা "নিবন্ধন করুন" বাটনে ক্লিক করুন। আপনার সঠিক ব্যক্তিগত এবং প্রাতিষ্ঠানিক তথ্য দিন, কাছের একটি পরীক্ষা কেন্দ্র নির্বাচন করুন এবং ফর্মটি জমা দিন। তাৎক্ষণিকভাবে আপনি রোল নম্বরসহ রেজিষ্ট্রেশন স্লিপ পেয়ে যাবেন।',
        'faq.q4': 'আমরা কিভাবে সাহায্য পেতে পারি?',
        'faq.a4': 'আমাদের ওয়েবসাইটের হিরো সেকশনে বা কুইক এক্সেসে থাকা "নিবন্ধন করুন" বাটনে ক্লিক করুন। আপনার সঠিক ব্যক্তিগত এবং প্রাতিষ্ঠানিক তথ্য দিন, কাছের একটি পরীক্ষা কেন্দ্র নির্বাচন করুন এবং ফর্মটি জমা দিন। তাৎক্ষণিকভাবে আপনি রোল নম্বরসহ রেজিষ্ট্রেশন স্লিপ পেয়ে যাবেন।',
...
// Slide 2
        "quotes.quote2": "\"একটি সুশিক্ষিত ও আলোকিত প্রজন্মই পারে দেশ ও সমাজের প্রকৃত রূপান্তর ঘটাতে। মুন্সিগঞ্জের ঐতিহ্যবাহী মাটিতে বেড়ে ওঠা মেধাবী শিক্ষার্থীদের স্বপ্ন পূরণের পথকে আরও মসৃণ করতেই 'বিক্রমপুর মানব সেবা ফাউন্ডেশন মেধাবৃত্তি'-এর এই আন্তরিক প্রয়াস।\n" +
            "মেধার যথাযথ মূল্যায়ন এবং আর্থিক সীমাবদ্ধতা জয় করে আমাদের সন্তানরা যেন তাদের সর্বোচ্চ প্রতিভার বিকাশ ঘটাতে পারে—এটাই আমাদের মূল ব্রত। আমার বিশ্বাস, এই উদ্যোগ শিক্ষার্থীদের নতুন উদ্যমে এগিয়ে যেতে অনুপ্রাণিত করবে। মেধা ও সৃজনশীলতায় বিকশিত হয়ে তারা আগামী দিনে দেশ ও জাতির কল্যাণে কাজ করবে—এটাই আমার একান্ত প্রত্যাশা।\n" +
            "আমাদের প্রাণপ্রিয় শিক্ষার্থীদের উজ্জ্বল ভবিষ্যৎ এবং ফাউন্ডেশনের এই মহতী যাত্রার\" বিস্তারিত দেখুন...",
...
// Slide 3
        "quotes.quote3": "\"একটি সুশিক্ষিত ও আলোকিত প্রজন্মই পারে দেশ ও সমাজের প্রকৃত রূপান্তর ঘটাতে। মুন্সিগঞ্জের ঐতিহ্যবাহী মাটিতে বেড়ে ওঠা মেধাবী শিক্ষার্থীদের স্বপ্ন পূরণের পথকে আরও মসৃণ করতেই 'বিক্রমপুর মানব সেবা ফাউন্ডেশন মেধাবৃত্তি'-এর এই আন্তরিক প্রয়াস।\n" +
            "মেধার যথাযথ মূল্যায়ন এবং আর্থিক সীমাবদ্ধতা জয় করে আমাদের সন্তানরা যেন তাদের সর্বোচ্চ প্রতিভার বিকাশ ঘটাতে পারে—এটাই আমাদের মূল ব্রত। আমার বিশ্বাস, এই উদ্যোগ শিক্ষার্থীদের নতুন উদ্যমে এগিয়ে যেতে অনুপ্রাণিত করবে। মেধা ও সৃজনশীলতায় বিকশিত হয়ে তারা আগামী দিনে দেশ ও জাতির কল্যাণে কাজ করবে—এটাই আমার একান্ত প্রত্যাশা।\n" +
            "আমাদের প্রাণপ্রিয় শিক্ষার্থীদের উজ্জ্বল ভবিষ্যৎ এবং ফাউন্ডেশনের এই মহতী যাত্রার\" বিস্তারিত দেখুন...",
